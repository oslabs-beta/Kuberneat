...
function Chart() {
    ...
    return (React.createElement(material_1.Box, { m: "20px" },
        ...
        React.createElement("div", { className: darkModeOn ? 'dash-dark' : 'dash-light' },
            React.createElement(Header_1.default, { title: "Charts", subtitle: "Just one of the many ways to visualize your cluster" }),
            React.createElement("div", { style: { color: 'purple' } }, "charts go here..."))));
}
;
